...
export const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'LLaMA', mono: '🦙', desc: 'Working with Meta\'s open-source LLM for fine-tuning, inference, and local deployment.' },
  ...
  },
  {
    ...
    icon: '🧠',
    skills: [
      { name: 'Generative AI', mono: 'GA', desc: 'Building applications with generative models — text generation, image synthesis, and creative AI.' },
      { name: 'LLMs', mono: 'LM', desc: 'Prompt engineering, fine-tuning, RAG integration, and deploying large language models at scale.' },
      { name: 'RAG', mono: 'RG', desc: 'Retrieval-Augmented Generation — hybrid search, vector stores, reranking, and context-aware responses.' },
      { name: 'API Integration', mono: 'AI', desc: 'Designing and consuming RESTful APIs, webhook integrations, and third-party service orchestration.' },
      { name: 'REST APIs', mono: 'RA', desc: 'Building scalable HTTP APIs with proper authentication, rate limiting, and documentation.' },
      { name: 'XGBoost', mono: 'XG', desc: 'Gradient boosting for tabular data — feature engineering, hyperparameter tuning, and model interpretation.' },
    ],
  },
];
